...
@section('title', "Hakkımızda | ".$settings->title)
                ...
                <div class="row wow fadeInUp">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="boxcar-title">
                            <h2>Hakkımızda</h2>
                            <div class="text">Müşterilerimize Değer Veriyoruz Ve Onların Güzel Bir Deneyim Yaşamasını
                                İstiyoruz
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="content-box">
                            <div class="text">Lorem ipsum dolor sit amet consectetur. Convallis integer enim eget sit
                                urna. Eu duis lectus amet vestibulum varius. Nibh tellus sit sit at lorem facilisis.
                                Nunc vulputate ac interdum aliquet
                                vestibulum in tellus.
                            </div>
                            <div class="text">Sit convallis rhoncus dolor purus amet orci urna. Lobortis vulputate
                                vestibulum consectetur donec ipsum egestas velit laoreet justo. Eu dignissim egestas
                                egestas
                                ipsum. Sit est nunc pellentesque at a aliquam ultrices consequat. Velit duis velit nec
                                amet eget
                                eu morbi. Libero non diam sit viverra dignissim. Aliquam tincidunt in cursus euismod
                                enim.
                            </div>
                            <div class="text">Magna odio sed ornare ultrices. Id lectus mi amet sit at sit arcu mi nisl.
                                Mauris
                                egestas arcu mauris.
                            </div>
                        </div>
        ...
        <div class="why-choose-us-section">
            <div class="boxcar-container">
                <div class="boxcar-title wow fadeInUp">
                    <h2 class="title">Neden Bizi Seçmelisiniz?</h2>
                </div>
                <div class="row">
                    <!-- choose-us-block -->
                    <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="51" height="60" viewbox="0 0 51 60"
                                    ...
                                    <g clip-path="url(#clip0_24_628)">
                                        <path
                                            ...
                                            fill="#EEF1FB"></path>
                                        <path d="M23.3708 41.3167L36.6292 28.0583" stroke="#FF5CF4" stroke-width="3"
                                              stroke-miterlimit="10" stroke-linecap="round"
                                              stroke-linejoin="round"></path>
                                        <path d="M30 21.0938L44.0625 2.34375" stroke="#405FF2" stroke-width="3"
                                              stroke-miterlimit="10" stroke-linecap="round"
                                              stroke-linejoin="round"></path>
                                        <path d="M15.9375 2.34375L25.3895 12.9483" stroke="#405FF2" stroke-width="3"
                                              stroke-miterlimit="10" stroke-linecap="round"
                                              stroke-linejoin="round"></path>
                                        <path
                            ...
                            <div class="content-box">
                                <h6 class="title">Özel Finansman Teklifleri</h6>
                                <div class="text">Paradan tasarruf etmenizi sağlayacak finansal çözümler bulabilen
                                    stressiz finans departmanımız.
                                </div>
                        ...
                        <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
                            <div class="icon-box">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewbox="0 0 60 60"
                                     fill="none">
                                    <path d="M30 2.34375V7.03125" stroke="#FF5CF4" stroke-width="3"
                                          stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M48.75 2.34375L44.0625 7.03125" stroke="#FF5CF4" stroke-width="3"
                                          stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke-linejoin="round"></path>
                                    <path d="M11.25 2.34375L15.9375 7.03125" stroke="#FF5CF4" stroke-width="3"
                                          stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M17.3849 29.5312H42.6151" stroke="#405FF2" stroke-width="3"
                                          stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M25.3125 24.8438L30 29.5312L34.6875 24.8438" stroke="#405FF2"
                                          stroke-width="3" stroke-miterlimit="10" stroke-linecap="round"
                                          stroke-linejoin="round"></path>
                                    <path d="M30 43.5938V29.7306" stroke="#405FF2" stroke-width="3"
                                          stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                            <div class="content-box">
                                <h6 class="title">Güvenilir Araç Bayisi</h6>
                                <div class="text">Paradan tasarruf etmenizi sağlayacak finansal çözümler bulabilen
                                    stressiz finans departmanımız.
                                </div>
                            </div>
                    ...
                    <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewbox="0 0 60 60"
                                    ...
                                    <g clip-path="url(#clip0_24_681)">
                                        ...
                                        <path
                                            ...
                                            stroke="#405FF2" stroke-width="3" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M16.9749 38.3378L20.2894 35.0232" stroke="#405FF2" stroke-width="3"
                                              stroke-miterlimit="10" stroke-linecap="round"
                                              stroke-linejoin="round"></path>
                                        <path d="M33.5476 21.765L36.8621 18.4504" stroke="#405FF2" stroke-width="3"
                                              stroke-miterlimit="10" stroke-linecap="round"
                                              stroke-linejoin="round"></path>
                                        <path d="M43.5938 57.6562L57.6563 43.5937" stroke="#FF5CF4" stroke-width="3"
                                              stroke-miterlimit="10" stroke-linecap="round"
                                              stroke-linejoin="round"></path>
                                    </g>
                                    <defs>
                            ...
                            <div class="content-box">
                                <h6 class="title">Şeffaf Fiyatlandırma</h6>
                                <div class="text">Paradan tasarruf etmenizi sağlayacak finansal çözümler bulabilen
                                    stressiz finans departmanımız.
                                </div>
                            </div>
                    ...
                    <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="content-box">
                                <h6 class="title">Uzman Araç Servisi</h6>
                                <div class="text">Paradan tasarruf etmenizi sağlayacak finansal çözümler bulabilen
                                    stressiz finans departmanımız.
                                </div>
                            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="image-column col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-column">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/pricing1-1.jpg" alt=""></a>
                                </figure>
                                <a href="https://www.youtube.com/watch.html?v=Fvae8nxzVz4" class="play-now"
                                   data-fancybox="gallery" data-caption=""><i class="fa fa-play" aria-hidden="true"></i><span
                                        class="ripple"></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="content-column col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-column">
                            <div class="boxcar-title wow fadeInUp">
                                <h2>Bize Bugün Aracınızı Satın, Adil Fiyat Alın</h2>
                                <div class="text">Müşterilerimize olağanüstü hizmet, rekabetçi fiyatlar ve geniş bir
                                    yelpaze sunma konusunda kararlıyız.
                                </div>
                            </div>
                            <ul class="list-style-one wow fadeInUp" data-wow-delay="100ms">
                                <li><i class="fa-solid fa-check"></i>Ülkenin en büyük sağlayıcısıyız, daha fazla yerde
                                    daha fazla devriye aracımız var
                                </li>
                                <li><i class="fa-solid fa-check"></i>24/7 yol yardımı alırsınız</li>
                                <li><i class="fa-solid fa-check"></i>Yolda 5 aracın 4'ünü tamir ediyoruz</li>
                            </ul>
                            <a href="{{ route('index') }}" class="read-more wow fadeInUp" data-wow-delay="200ms">Başlayın
                    ...
                    <div class="row">
                        ...
                        <div class="counter-block col-lg-3 col-md-3 col-sm-4 wow fadeInUp">
                            <div class="inner wow fadeInUp">
                                <div class="content">
                                    <div class="widget-counter"><span class="count-text" data-speed="3000"
                                                                      data-stop="834">0</span>M
                                    </div>
                                    <h6 class="counter-title">SATILIK ARABALAR</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="counter-block col-lg-3 col-md-3 col-sm-4 wow fadeInUp" data-wow-delay="300ms">
                            <div class="inner wow fadeInUp" data-wow-delay="100ms">
                                <div class="content">
                                    <div class="widget-counter"><span class="count-text" data-speed="3000"
                                                                      data-stop="732">0</span>M
                                    </div>
                                    <h6 class="counter-title">SATICI YORUMLARI</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="counter-block col-lg-3 col-md-3 col-sm-4 wow fadeInUp" data-wow-delay="600ms">
                            <div class="inner wow fadeInUp" data-wow-delay="200ms">
                                <div class="content">
                                    <div class="widget-counter"><span class="count-text" data-speed="3000"
                                                                      data-stop="90">0</span>M
                                    </div>
                                    <h6 class="counter-title">GÜNLÜK ZİYARETÇİLER</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="counter-block col-lg-3 col-md-3 col-sm-4 wow fadeInUp" data-wow-delay="900ms">
                            <div class="inner wow fadeInUp" data-wow-delay="300ms">
                                <div class="content">
                                    <div class="widget-counter"><span class="count-text" data-speed="3000"
                                                                      data-stop="236">0</span>M
                                    </div>
                                    <h6 class="counter-title">DOĞRULANMIŞ SATICILAR</h6>
                                </div>
                            </div>
                        </div>
                    </div>
