        ...
        <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
            ...
            <div class="header-top-container container-xxl sabi d-flex flex-grow-1 flex-stack">
                ...
                <div class="d-flex align-items-center me-5">
                    ...
                    <a href="{{ route('index') }}">
                        <!--begin::Desktop modes-->
                        <img alt="Logo" src="/assets/media/logos/logo_new.png" class="d-none d-lg-inline-block h-50px" />
                        <!--end::Desktop modes-->
                        <!--begin::Table & mobile modes-->
                        <img alt="Logo" src="/assets/media/logos/default-small.svg" class="d-lg-none h-25px" />
                    ...
                    <div class="d-flex align-items-center ms-2 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bold d-flex align-items-center fs-5">{{ \Illuminate\Support\Facades\Auth::user()->name.' '.strtoupper(\Illuminate\Support\Facades\Auth::user()->surname) }}
                                            @if(\Illuminate\Support\Facades\Auth::user()->is_admin)
                                                <span class="badge badge-light-info fw-bold fs-8 px-2 py-1 ms-2">Yönetici</span>
                                            @endif
                                        </div>
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('logout') }}" class="menu-link px-5">Oturumu Kapat</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
            ...
            <div class="header-menu-container d-flex align-items-stretch flex-stack w-100" id="kt_header_nav">
                ...
                <div class="header-menu container-xxl flex-column align-items-stretch flex-lg-row" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    ...
                    <div class="menu menu-column menu-lg-row menu-rounded menu-active-bg menu-title-gray-800 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch flex-grow-1 px-2 px-lg-0" id="kt_header_menu" data-kt-menu="true">
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item @if(Route::is('admin_get_car_list') || Route::is('admin_get_add_car') || Route::is('admin_get_car_images')) here @endif  me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route('admin_get_car_list') }}" class="menu-link py-3">
                                <span class="menu-title">@if(\Illuminate\Support\Facades\Auth::user()->is_admin) Tüm İlanlar @else İlanlarım @endif</span>
                        ...
                        <!--end:Menu item-->
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item @if(Route::is('admin_get_comments')) here @endif me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route('admin_get_comments') }}" class="menu-link py-3">
                        ...
                        @if(\Illuminate\Support\Facades\Auth::user()->is_admin)
                            <!--begin:Menu item-->
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item @if(Route::is('admin_get_messages')) here @endif me-0 me-lg-2">
                                <!--begin:Menu link-->
                                <a href="{{ route('admin_get_messages') }}" class="menu-link py-3">
                            ...
                            <!--end:Menu item-->
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item @if(Route::is('admin_get_categories')) here @endif me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route('admin_get_categories') }}" class="menu-link py-3">
                        ...
                        <!--end:Menu item-->
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item @if(Route::is('admin_get_brands')) here @endif  me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route('admin_get_brands') }}" class="menu-link py-3">
                        ...
                        <!--end:Menu item-->
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item @if(Route::is('admin_get_users')) here @endif me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route('admin_get_users') }}" class="menu-link py-3">
                        ...
                        <!--end:Menu item-->
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item @if(Route::is('admin_get_settings')) here @endif me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route("admin_get_settings") }}" class="menu-link py-3">
