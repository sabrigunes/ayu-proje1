...
@section('title', "Bize Ulaşın | ".$settings->title)
...
@section('content')
    ...
    <section class="contact-us-section layout-radius">
        <div class="boxcar-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 content-column">
                            <div class="inner-column">
                                ...
                                <form class="row" action="{{ route('post_contact') }}" method="post">
                                    @csrf
                                    <div class="col-lg-6">
                                    ...
                                    <div class="form-submit">
                                        <button type="submit" class="theme-btn">Mesajı Gönder<img src="images/arrow.svg" alt="">
                                        </button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="contact-column col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column">
                                <div class="boxcar-title">
                                    ...
                                    <div class="text">{{ $settings->contact }}</div>
                                </div>
                                ...
                                <div class="content-box">
                                    <h6 class="title">
                                        ...
                                        Eposta Adresi</h6>
                                    <div class="text"><a href="mailto:{{ $settings->email }}">{{ $settings->email }}</a></div>
                                </div>
                                <div class="content-box">
                                    <h6 class="title">
                                        <span class="icon">
                                        ...
                                        Telefon Numarası</h6>
                                    <div class="text"><a href="tel:{{ $settings->phone }}">{{ $settings->phone }}</a></div>
                                </div>
                                <div class="social-icons">
                                    <h6 class="title">Bizi sosyal medyada takip edin</h6>
                                    <ul class="social-links">
                                        <li><a href="https://facebook.com/{{ $settings->facebook }}"><i class="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="https://twitter.com/{{ $settings->twitter }}"><i class="fa-brands fa-twitter"></i></a></li>
                                        <li><a href="https://instagram.com/{{ $settings->instagram }}"><i class="fa-brands fa-instagram"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <!-- map-sec -->
            <div class="map-sec mt-5">
                <div class="goole-iframe">
                    <iframe src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Maslak%20Atat%C3%BCrk%20Oto%20Sanayi%20Sitesi%202.%20K%C4%B1s%C4%B1m%2032.%20Sokak%20No%20:%20718,%2034485%20Sar%C4%B1yer/%C4%B0stanbul+(AracSat)&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
